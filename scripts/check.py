...
checked = 0
site_roots = [ROOT / 'reworxct', ROOT / 'ember-and-iron', ROOT / 'garys-hilltop', ROOT / 'mach-detail', ROOT / 'waterbury-aquarium', ROOT / 'barbers-ink', ROOT / 'empanadas-togo', ROOT / 'weathershield']
